...
public final class ImageParser {
    ...
    private final PlaceholderDatabase placeholderDatabase;

    @Inject
    public ImageParser(PlaceholderDatabase placeholderDatabase) {
     ...
     */
    public List<SourcedImage> parse(String placeId, List<CorpusData> list) {
