<template>
  <div>
    <b-container class="Dashboard">
      <b-row>
        <b-col cols="12" md="6" v-for="task in typeList" :key="task.path" class="d-flex align-items-stretch">
          <data-group-box v-bind="task" class="d-flex align-items-stretch"></data-group-box>
        </b-col>
      </b-row>
    </b-container>
  </div>
